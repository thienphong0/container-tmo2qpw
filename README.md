...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tmo2qpw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tmo2qpw.containers.anotherwebservice.com/
...
```
git clone git@github.com:thienphong0/container-tmo2qpw.git
cd container-tmo2qpw
```
...
```
docker attach container-tmo2qpw
```
